...
public class MaskedTokenPrediction {
    ...
    public static void main(String[] args) throws IOException, OrtException {
        ...
        String[] sentences = new String[]{"int [MASK] = getCount();"};

//        HuggingFaceTokenizer tokenizer = HuggingFaceTokenizer.newInstance(Paths.get("artifacts/albert_base/albert_tokenizer.json"));
